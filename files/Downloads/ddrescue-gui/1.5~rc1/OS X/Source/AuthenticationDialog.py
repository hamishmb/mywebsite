#!/usr/bin/env python
# -*- coding: utf-8 -*- 
# Authentication Dialog for DDRescue-GUI Version 1.5~rc2
...
class AuthWindow(wx.Frame):  
    def __init__(self):
        ...
        wx.Frame.__init__(self, None, title="DDRescue-GUI - Authenticate", size=(600,400), style=(wx.DEFAULT_FRAME_STYLE | wx.STAY_ON_TOP) ^ (wx.RESIZE_BORDER | wx.MINIMIZE_BOX)) #*** Figure out the right size ***
