#!/usr/bin/env python
# -*- coding: utf-8 -*- 
# DDRescue-GUI Main Script Version 1.5~rc1
...
class MainWindow(wx.Frame):
    ...
    def OnExit(self, Event=None, JustFinishedRec=False): #*** Test this again ***
...
class FinishedWindow(wx.Frame):  
    ...
    def MountOutputFile(self, Event=None):
        ...
        #Use different methods for OS X and Linux. Also catch any unhandled errors. *** Make this more user-friendly ***
        if Linux:
            try:
