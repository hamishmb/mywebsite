    ...
    <body>
        ...
        <div id="MainContent">
            ...
            <nav>
                ...
                <ol id="InPageNavigation">
                    ...
                    <li>
                        ...
                        <ol>    
                            <li><a href="#1.7.1">1.7.1 (Stable)</a></li>
            ...
            <section>
                ...
                <article>
                    <h3 id="1.7.1">DDRescue-GUI v1.7.1</h3>
                    <p class="TextFile"><?php echo nl2br(file_get_contents($GLOBALS["BASEDIR"] . "/files/Changelogs/ddrescue-gui/1.7.1.txt"))?>
                    </p>
                </article>
                <article>
