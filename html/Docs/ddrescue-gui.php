...
<html lang="en">
    ...
    <body>
        ...
        <!-- Content of the Page -->
        <div id="MainContent">
            <h1>Documentation For DDRescue-GUI</h1>
            <p>
            The current version of the documentation is for DDRescue-GUI 1.7.1 and Higher, for both Mac and Linux.
            </p>

            <p>
            You can view the documentation online, or download in a few formats. Source code for the documentation can be found at <a href="https://github.com/hamishmb/docs" target="_blank">https://github.com/hamishmb/docs</a>.
            </p>

            <p>
            <ul>
                <li><a href="ddrescue-gui/index.html" target="_blank">View Documentation Online</a></li>
