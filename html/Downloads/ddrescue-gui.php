        ...
        <div id="MainContent">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/ddrescue-gui/1.6.1/Yakkety/ddrescue-gui_1.6.1~yakkety-0ubuntu1~ppa1_all.deb.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Ubuntu_logo_copyleft_1.jpg" width="40" height="40" alt="Copyleft Ubuntu Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/ddrescue-gui/1.6.1/Xenial/ddrescue-gui_1.6.1~xenial-0ubuntu1~ppa1_all.deb.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Ubuntu_logo_copyleft_1.jpg" width="40" height="40" alt="Copyleft Ubuntu Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/ddrescue-gui/1.6.1/Trusty/ddrescue-gui_1.6.1~trusty-0ubuntu1~ppa1_all.deb.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Ubuntu_logo_copyleft_1.jpg" width="40" height="40" alt="Copyleft Ubuntu Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/ddrescue-gui/1.6.1/Precise/ddrescue-gui_1.6.1~precise-0ubuntu1~ppa1_all.deb.counter"); ?></td>
                </tr>
                <tr>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/ddrescue-gui/1.6.1/OS X/64-bit/DDRescue-GUI64-bit.dmg.counter"); echo " and "; $junk = readfile($BASEDIR . "/files/Downloads/ddrescue-gui/1.6.1/OS X/32-bit/DDRescue-GUI32-bit.dmg.counter"); ?></td>
                </tr>
                <tr>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/ddrescue-gui/1.6.1/Fedora/64-bit/ddrescue-gui-1.6.1-1.fc24.x86_64.rpm.counter"); echo " and "; $junk = readfile($BASEDIR . "/files/Downloads/ddrescue-gui/1.6.1/Fedora/32-bit/ddrescue-gui-1.6.1-1.fc24.i686.rpm.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Linux_logo.jpg" width="34" height="40" alt="Linux Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/ddrescue-gui/1.6.1/Pmagic/ddrescue-gui_1.6.1~pmagic-0ubuntu1~ppa1.tar.gz.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Linux_logo.jpg" width="34" height="40" alt="Linux Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/ddrescue-gui/1.6.1/OtherDistro/ddrescue-gui_1.6.1~otherdistro-0ubuntu1~ppa1.tar.gz.counter"); ?></td>
                </tr>
            </table>
            <br>
