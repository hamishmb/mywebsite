        ...
        <div id="MainContent">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/wineautostart/2.0.2/Yakkety/wineautostart_2.0.2yakkety-0ubuntu1~ppa1_all.deb.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Ubuntu_logo_copyleft_1.jpg" width="40" height="40" alt="Copyleft Ubuntu Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/wineautostart/2.0.2/Xenial/wineautostart_2.0.2xenial-0ubuntu1~ppa1_all.deb.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Ubuntu_logo_copyleft_1.jpg" width="40" height="40" alt="Copyleft Ubuntu Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/wineautostart/2.0.2/Trusty/wineautostart_2.0.2trusty-0ubuntu1~ppa1_all.deb.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Ubuntu_logo_copyleft_1.jpg" width="40" height="40" alt="Copyleft Ubuntu Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/wineautostart/2.0.2/Precise/wineautostart_2.0.2precise-0ubuntu1~ppa1_all.deb.counter"); ?></td>
                </tr>
                <tr>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/wineautostart/2.0.2/Otherdistro/wineautostart_2.0.2otherdistro-0ubuntu1~ppa1.tar.gz.counter"); ?></td>
                </tr>
            </table>
            <br>
