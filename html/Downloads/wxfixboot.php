        ...
        <div id="MainContent">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/wxfixboot/2.0/Yakkety/wxfixboot_2.0yakkety~update1-0ubuntu1~ppa1_all.deb.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Ubuntu_logo_copyleft_1.jpg" width="40" height="40" alt="Copyleft Ubuntu Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/wxfixboot/2.0/Xenial/wxfixboot_2.0xenial~update1-0ubuntu1~ppa1_all.deb.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Ubuntu_logo_copyleft_1.jpg" width="40" height="40" alt="Copyleft Ubuntu Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/wxfixboot/2.0/Trusty/wxfixboot_2.0trusty~update1-0ubuntu1~ppa1_all.deb.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Ubuntu_logo_copyleft_1.jpg" width="40" height="40" alt="Copyleft Ubuntu Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/wxfixboot/2.0/Precise/wxfixboot_2.0precise~update1-0ubuntu1~ppa1_all.deb.counter"); ?></td>
                </tr>
                <tr>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/wxfixboot/2.0/Fedora/x86_64/wxfixboot-2.0-1.fc24.x86_64.rpm.counter"); echo " and "; $junk = readfile($BASEDIR . "/files/Downloads/wxfixboot/2.0/Fedora/i686/wxfixboot-2.0-1.fc24.i686.rpm.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Linux_logo.jpg" width="34" height="40" alt="Linux Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/wxfixboot/2.0/Pmagic/wxfixboot_2.0pmagic~update1-0ubuntu1~ppa1.tar.gz.counter"); ?></td>
                </tr>
                <tr>
                    <td><img src="/files/Icons/Linux_logo.jpg" width="34" height="40" alt="Linux Logo"></td>
                    ...
                    <td><?php $junk = readfile($BASEDIR . "/files/Downloads/wxfixboot/2.0/OtherDistro/wxfixboot_2.0otherdistro~update1-0ubuntu1~ppa1.tar.gz.counter"); ?></td>
                </tr>
            </table>
            <br>
