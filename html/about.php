...
<html lang="en">
    <head>
        ...
        <title>About This Website - www.hamishmb.com</title>
        ...
        <div id="MainContent">
            <section>
                ...
                <article>
                    ...
                    <p>
                    This website is a useful resource for people who want to use or download my programs, and also those who want to read the changelogs and explore the museum.<br><br>
                ...
                <article>
                    ...
                    <p>
                    DDRescue-GUI is a fast, free, and open-source GUI for GNU ddrescue, and makes this powerful tool accessible to everyone. It runs on both Linux and MacOS, and is included in Parted Magic (see website <a target="_blank" href="http://www.partedmagic.com">here</a>). It features a simple, intuitive interface that helps you get started, and detects all of your disks (including LVM and RAID disks) so you can select them more easily. It's designed to recover your data and get you back on your feet quickly, and it's written to be efficient so that on laptops your battery lasts as long as possible in case you can't plug in to power. When your recovery is finished, DDRescue-GUI also allows you to mount your output file or device (make it accessible in layman's terms) and access your data fast.
                    </p>
                    <h3>WxFixBoot</h3>
                    <img class="Screenshot" src="/files/Logos/WxFixBoot.jpg" alt="WxFixBoot">
                    <p>
