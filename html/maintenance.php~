...
<html lang="en">
    <head>
        ...
        <title>Down for maintenance - hamishmb.altervista.org</title>
        <?php include_once './config.php' ; ?>
    </head>
    <body>
        <!-- Content of the Page -->
        <div>
            <h1>This website is currently being updated and is temporarily down for maintenance. Check back soon!</h1>
        </div>
