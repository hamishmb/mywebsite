...
if (isset($_GET['program_name'])) {
    ...
    $programs = ['wineautostart', 'wxfixboot', 'ddrescue-gui', 'getdevinfo'];
    $programs_user_friendly = ['Wine Autostart', 'WxFixBoot', 'DDRescue-GUI', 'GetDevInfo'];
...
<html lang="en">
    ...
    <body>
        ...
        <div id="MainContent">
            ...
            The digital signatures on this page can be used to verify that your file was created by me, and hasn't been tampered with, either on the web server, or in transit to your computer. Checking these is more dificult, so I have decided not to include instructions here because they'd have to be very long to do it justice. Instead, please carry out a search on how to verify GPG signatures if you wish to learn how to do it.<br><br>
